...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/SKPAdBenefit/SKPAdBenefit.framework"
  install_framework "${PODS_ROOT}/SKPAdBenefit/SKPAdBenefitNative.framework"
  install_framework "${PODS_ROOT}/SKPAdBenefit/SKPAdBenefitInterstitial.framework"
  install_framework "${PODS_ROOT}/SKPAdBenefit/SKPAdBenefitFeed.framework"
  install_framework "${PODS_ROOT}/SKPAdBenefit/SKPAdBenefitWebInterface.framework"
